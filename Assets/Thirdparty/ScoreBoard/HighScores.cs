...
{
    const string privateCode = "SiJ54xdAjUu9acabAkBZuQRSF0d9YUXkOlgU5U3tkHGg";  //Key to Upload New Info
    const string publicCode = "62aa07658f40bb11c0832956";   //Key to download
